...
#include "components/themes/customc6/CustomC6ReaderTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::LYRA_3_COVERS:
      ...
      break;
    case CrossPointSettings::UI_THEME::CUSTOM_C6_READER:
      LOG_DBG("UI", "Using Custom C6 Reader theme");
      currentTheme = std::make_unique<CustomC6ReaderTheme>();
      currentMetrics = &CustomC6ReaderMetrics::values;
      break;
  }
}
